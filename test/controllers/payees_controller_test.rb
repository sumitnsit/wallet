...
class PayeesControllerTest < ActionController::TestCase
  ...
  test "should create payee" do
    assert_difference('Payee.count') do
      post :create, payee: { contact: @payee.contact, name: @payee.name, note: @payee.note, url: @payee.url }
    end
  ...
  test "should update payee" do
    patch :update, id: @payee, payee: { contact: @payee.contact, name: @payee.name, note: @payee.note, url: @payee.url }
    assert_redirected_to payee_path(assigns(:payee))
  end
